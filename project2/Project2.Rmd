...
SR_AP <- surv_data$`Academic Performance`
...
names(surv_data$`Academic Performance`) <- divided_ac
SR_AP <- names(surv_data$`Academic Performance`)
...
ggplot(surv_data, aes(x=`Physical Activity`, y=ATAR)) +
  geom_point()
```
